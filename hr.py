...
# Replace with your bot's token and group IDs
BOT_TOKEN = "7846291656:AAHRBfGkwGJeLlHEa--JtbYO-HjV14x1iWo"
GROUP_IDS = {-1002414507376, -1002276735683}  # Replace with your actual groups' numeric IDs
...
packet_size = 9  # Define packet size
...
async def attack(update: Update, context: CallbackContext):
    ...
    # Check if the command is given in one of the allowed groups
    if chat_id not in GROUP_IDS:
        await context.bot.send_message(
            chat_id=user_id,
            text="I am built such that I can only process requests in the specified groups.\n"
                 "2. 🎁🎀JOIN CHANNEL :- \n"
                 "3.🩵💗GROUP LINK :- \n"
...
async def start(update: Update, context: CallbackContext):
    ...
    if chat_id in GROUP_IDS:
        ...
        await update.message.reply_text("🚫 This bot can only be used in the specified groups.")
